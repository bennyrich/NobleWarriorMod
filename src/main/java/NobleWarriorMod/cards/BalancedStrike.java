...
public class BalancedStrike extends CustomCard {
    public static final String ID = "NobleWarrior:BalancedStrike";
    ...
    public BalancedStrike() {
        super(ID, NAME, NobleWarriorMod.getCardImagePath(ID), COST,
                DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCardEnum.NOBLEWARRIOR_ORANGE, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
