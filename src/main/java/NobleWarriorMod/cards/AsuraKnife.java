...
public class AsuraKnife extends AbstractClassCard {
    private static final String ID = "NobleWarrior:AsuraKnife";
    ...
    private static final AbstractCard PREV2 = new DrawOutAsuraKnife();
    private static AbstractCard PREV2U = new DrawOutAsuraKnife();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractCard c1 = new DrawOutAsuraKnife();
